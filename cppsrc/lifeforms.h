...
// formula is (energy gained * energy gained) * multiplier
#define HERB_DIGEST_TIME_MULTIPLIER .006 * (1.0 / HERB_FOOD_MULTIPLIER)
#define CARN_DIGEST_TIME_MULTIPLIER .006 * (1.0 / CARN_FOOD_MULTIPLIER)
...
#define FLOWER_COST 0.75 * ENERGY_DENSITY_MULTIPLIER
