...
#define MOVE_COST_MULTIPLIER 1.2
#define REPRODUCTION_COOLDOWN_MULTIPLIER 5 * LIFESPAN_MULTIPLIER
...
#define PHOTOSYNTHESIS_ENERGY_MULTIPLIER (2.5 / LIFESPAN_MULTIPLIER)
...
#define KILLER_TICK_COST 6 * PHOTOSYNTHESIS_ENERGY_MULTIPLIER
