...
#define HERB_FOOD_MULTIPLIER 3 * ENERGY_DENSITY_MULTIPLIER
#define CARN_FOOD_MULTIPLIER 65 * ENERGY_DENSITY_MULTIPLIER
...
#define BIOMASS_SPOIL_TIME_MULTIPLIER 10 * SPOILTIME_BASE
...
#define BIOMASS_FOOD_ENERGY 10 * PLANTMASS_FOOD_ENERGY
...
#define ARMOR_HEALTH_BONUS 10 * MAX_HEALTH_MULTIPLIER
