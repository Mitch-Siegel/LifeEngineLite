...
#define LIFESPAN_MULTIPLIER 30.0
#define LIFESPAN(maxEnergy, nCells) LIFESPAN_MULTIPLIER * (maxEnergy / ENERGY_DENSITY_MULTIPLIER) * sqrt(nCells)


#define MOVE_COST_MULTIPLIER 0.5
#define REPRODUCTION_COOLDOWN_MULTIPLIER 10 * LIFESPAN_MULTIPLIER
...
#define PHOTOSYNTHESIS_ENERGY_MULTIPLIER (2.0 / LIFESPAN_MULTIPLIER)
#define FLOWER_COST 1 * ENERGY_DENSITY_MULTIPLIER
#define LEAF_FLOWERING_COOLDOWN 1 * LIFESPAN_MULTIPLIER
...
#define FLOWER_EXPAND_PERCENT 30

#define BARK_GROW_COOLDOWN 2 * LIFESPAN_MULTIPLIER
#define BARK_PLANT_VS_THORN 95
#define BARK_GROW_COST 40 * PHOTOSYNTHESIS_ENERGY_MULTIPLIER
#define BARK_MAX_INTEGRITY 5
#define BARK_BONUS_ENERGY_DIVIDER 2
...
#define FLOWER_BLOOM_COST 20 * PHOTOSYNTHESIS_ENERGY_MULTIPLIER

#define KILLER_DAMAGE_COST 80 * PHOTOSYNTHESIS_ENERGY_MULTIPLIER
// must have at least 4 leaves to support a killer (if plant)
#define KILLER_TICK_COST 8 * PHOTOSYNTHESIS_ENERGY_MULTIPLIER
